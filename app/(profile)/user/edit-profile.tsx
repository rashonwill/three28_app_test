	     ...
	     <div className="flex flex-col items-center justify-center gap-2 w-full h-[4rem] mt-[3rem]">
              ...
              <div className='flex justify-end gap-4 px-4 py-8'>
                <Dialog.Close asChild>
                  <Button className='bg-gradient-to-r from-primary-light to-primary-dark text-primary-foreground h-[3rem] text-3xl px-12 rounded-2xl shadow-lg hover:shadow-xl transition-all capitalize dark:text-[#fdfbf9]'>Cancel</Button>
                </Dialog.Close>
                  <Button className='bg-gradient-to-r from-primary-light to-primary-dark text-primary-foreground h-[3rem] text-3xl px-12 rounded-2xl shadow-lg hover:shadow-xl transition-all capitalize dark:text-[#fdfbf9]' onClick={() => {editBio(); editHandle(); editLocation(); updatePoster(); updateAvatar();}} >Save</Button>
              </div>
            </ScrollArea.Viewport>
