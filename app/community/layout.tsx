...
export const metadata = {
  ...
  keywords: ['video sharing','community', 'youtube', 'video monetization', 'social media', 'video sharing platform', 'content monetization', 'Three28', 'Three28 social media site', 'Three28 video platform', 
